class Game {
  ...
  start() {
    ...
    //handelgrass(index) {
      //cars[index-1].overlap(grass,function(collector,collected){collected.remove()})
      
    //}
//handleBush(index) {
  //    cars[index-1].overlap(bush,function(collector,collected){collected.remove()})
    //  
      //}
...
//animal1.positionY= camera.positionY
//animal2.positionY= camera.positionY
animal1.position.x = cars[index - 1].position.x;
animal2.position.y = cars[index - 1].position.y;
